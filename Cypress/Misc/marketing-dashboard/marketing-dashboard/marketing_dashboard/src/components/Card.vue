      ...
      <div class="row">
        ...
        <div class="col-lg-4 text-right">
          <div class="breadcome-heading">
            ...
            <img src="../assets/undo.png" v-if="filterApplied !== '' && data.renderAt === 'chart-container-country'" height="30px" width="20px" style="cursor:pointer" @click="undoChart" >
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    renderChart() {
      ...
      if (this.data.renderAt === "chart-container-traffic") {
        this.dataSource.chart = Object.assign({}, this.data.chartCosmetics);
        this.dataSource.categories = [
          {
            category: label
      ...
      if (this.data.renderAt === "chart-container-industries") {
        this.dataSource.chart = Object.assign({}, this.data.chartCosmetics);
        this.dataSource.categories = [
          {
            category: label
